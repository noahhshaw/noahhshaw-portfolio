(function () {
  const places = [
    ...
    { id: 'a-mano',            name: 'a Mano',                                address: '450 Hayes St, San Francisco, CA 94102',                coords: [37.7768, -122.4244], area: 'civic-center' },
    ...
    { id: 'piccino',           name: 'Piccino',                               address: '1001 Minnesota St, San Francisco, CA 94107',           coords: [37.7567, -122.3897], area: 'dogpatch' },
    { id: 'neighbor-bakehouse',name: 'Neighbor Bakehouse',                    address: '2343 3rd St, San Francisco, CA 94107',                 coords: [37.7587, -122.3895], area: 'dogpatch' },
    ...
    { id: 'palace',            name: 'Palace of Fine Arts',                   address: '3301 Lyon St, San Francisco, CA 94123',                coords: [37.8029, -122.4484], area: 'marina' },
    ...
    { id: 'greens',            name: 'Greens Restaurant',                     address: '2 Marina Blvd, San Francisco, CA 94123',               coords: [37.8064, -122.4321], area: 'marina' },
